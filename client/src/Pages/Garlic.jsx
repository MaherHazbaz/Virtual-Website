...
// 3D Model Component
const Model = () => {
  const { scene } = useGLTF("/models/garlic1/garlic1.gltf");
  return <primitive object={scene} scale={10} position={[-5, -3, 2]} />;
};
          ...
          <Html position={[5, 2, 20]} center>
            ...
            >
              <div className="mt-2 text-gray-600">
                ...
                <p className="mb-4">
                  Garlic is a bulbous plant from the Allium family, well-known
                  for its distinctive flavor and numerous health benefits. Used
                  in cooking and traditional medicine, garlic is celebrated for
                  its immune-boosting and heart-protective properties.
                </p>
                <div className="space-y-2">
                  <p>
                    <span className="font-semibold">Heart health:</span> Garlic
                    may help lower cholesterol levels, reduce blood pressure,
                    and improve overall heart health.
                  </p>
                  <p>
                    <span className="font-semibold">Immune support:</span>{" "}
                    Garlic is known to enhance immune function, helping the body
                  ...
                  <p>
                    ...
                    Garlic contains antioxidants that help protect cells from
                    oxidative stress and reduce inflammation.
                  </p>
                  <p>
                    <span className="font-semibold">Digestive health:</span>{" "}
                    Garlic may support digestive health by promoting beneficial
                    gut bacteria and aiding in detoxification.
                  </p>
                  <p>
                    <span className="font-semibold">
                      Potential cancer-fighting properties:
                    </span>{" "}
                    Some studies suggest that garlic may have anti-cancer
                    effects due to its ability to enhance immune function and
                    reduce inflammation.
                  </p>
                  <p>
                    <span className="font-semibold">Nutrient-rich:</span> Garlic
                    is low in calories but high in vitamins C and B6, manganese,
                    .
                  </p>
